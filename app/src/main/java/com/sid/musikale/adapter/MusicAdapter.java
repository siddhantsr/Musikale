...
public class MusicAdapter extends RecyclerView.Adapter<MusicAdapter.MyVieHolder> {
    ...
    public void onBindViewHolder(@NonNull MyVieHolder holder, final int position) {
        ...
        if (image != null){
            ...
            Glide.with(mContext).load(R.drawable.song).into(holder.album_art);
        }
    ...
    public class MyVieHolder extends RecyclerView.ViewHolder{
        ...
        public MyVieHolder(@NonNull View itemView) {
            super(itemView);
            file_name=itemView.findViewById(R.id.song_file);
    ...
    public void  update(ArrayList<MusicFiles> musicFilesArrayList){
